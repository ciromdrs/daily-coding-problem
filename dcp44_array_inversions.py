...
inversion if A[i] > A[j] but i < j. That is, a smaller element appears
after a larger element.
...
'''Solution: implement insertion-sort and, at every element swap, print
the pair of elements swapped.
